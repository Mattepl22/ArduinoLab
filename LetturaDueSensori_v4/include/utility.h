...
void timerInit(Timer *t, unsigned long trigger, bool mode = false); //Inizializzazione dei valori del timer
bool timerTrigger(Timer *t); //Conteggio
void timerReset(Timer *t); //Reset del timer
